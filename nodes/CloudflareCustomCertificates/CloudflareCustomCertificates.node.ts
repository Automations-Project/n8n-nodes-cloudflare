...
import { customCertificateOperations, customCertificateFields } from './CustomCertificateDescription';
import { customCertificatesExecute } from './CustomCertificatesExecute';

export class CloudflareCustomCertificates implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Cloudflare Custom Certificates',
