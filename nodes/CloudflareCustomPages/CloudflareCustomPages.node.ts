...
import { customPagesOperations, customPagesFields } from './CustomPagesDescription';
import { customPagesExecute } from './CustomPagesExecute';

export class CloudflareCustomPages implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Cloudflare Custom Pages',
		...
		properties: [
			{
				...
				options: [{ name: 'Custom Page', value: 'customPage' }],
				default: 'customPage',
			},
