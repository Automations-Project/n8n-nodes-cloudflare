...
import { totalTlsOperations, totalTlsFields } from './TotalTlsDescription';
import { totalTlsExecute } from './TotalTlsExecute';

export class CloudflareTotalTls implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Cloudflare Total TLS',
