...
import { originCaOperations, originCaFields } from './OriginCaDescription';
import { originCaExecute } from './OriginCaExecute';

export class CloudflareOriginCa implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Cloudflare Origin CA',
